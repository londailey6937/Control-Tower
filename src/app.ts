...
const DEFAULT_DOCS: DocLibItem[] = [
    ...
    revisions: [
      {
        ...
        date: "2026-03-10",
        author: "Regulatory Lead",
        change: { en: "Initial comparison", cn: "初始比较" },
      },
    ],
  },
  {
    ...
    dcn: "DCN-TECH-001",
    cat: "technical",
    name: { en: "Device Design Specification", cn: "设备设计规格" },
    version: "1.0",
    date: "2026-03-12",
  ...
  },
  {
    ...
    dcn: "DCN-TECH-003",
    cat: "technical",
    name: { en: "Verification & Validation Plan", cn: "验证与确认计划" },
    version: "1.0",
    date: "2026-03-05",
    owner: "Technical Lead",
    status: "draft",
    ...
    revisions: [
      {
        ...
        date: "2026-03-05",
        author: "Technical Lead",
        change: { en: "Initial V&V plan", cn: "初始V&V计划" },
      },
    ],
  },
  {
    ...
    revisions: [
      {
        ...
        author: "Technical Lead",
        change: {
          en: "Initial risk management file",
          cn: "初始风险管理文件",
        },
      },
    ],
  },
  {
    ...
    cat: "business",
    name: {
      en: "Seed Round Term Sheet Template",
      cn: "种子轮条款清单模板",
    },
    version: "1.0",
    date: "2026-03-08",
    ...
    revisions: [
      {
        ...
        change: { en: "Initial term sheet template", cn: "初始条款清单模板" },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cat: "legal",
    name: {
      en: "US Entity Formation Documents",
      cn: "美国实体注册文件",
    },
    version: "1.0",
    date: "2025-09-01",
    ...
    revisions: [
      {
        ...
        date: "2026-03-20",
        author: "Finance Lead",
        change: { en: "Initial budget tracking", cn: "初始预算追踪" },
      },
    ],
  },
  {
  ...
  try {
    ...
    if (raw) {
      ...
      return {
        ...
        technologyEmail: parsed.technologyEmail ?? parsed.inventorEmail ?? "",
...
function exportQaThread(): void {
  ...
  const decisions = loadMBDecisions();
  const lines: string[] = [
    `${localizedText(PROJECT.name)} \u2014 Message Board Export`,
